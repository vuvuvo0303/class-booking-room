...
const Home = () => {
  return (
    <div>
      <div className="h-[780px] overflow-hidden drop-shadow-sm">
        <img
        ...
        <div className="absolute top-0 left-0 overflow-hidden h-[780px]">
          <div className="rounded-full bg-white w-[1000px] aspect-square  -translate-x-[300px] -translate-y-[100px]"></div>
        </div>
      </div>
      <div></div>
      <MaxWidthWrapper>
        <div className="flex justify-center my-5">
          <span className="text-4xl">Our System has</span>
        </div>
          ...
          <Card className="w-1/4">
            <CardContent>
              <div className="flex flex-col  items-center py-5 gap-2">
                ...
                <span className="pl-4 text-sm w-64">
                  In addition to facial recognition, we also add code codes on
                  the front doors of the rooms, in case of recognition errors,
                  we can still use the code we provide to open the door.
                </span>
              </div>
            </CardContent>
          </Card>
        ...
        <hr className="my-5" />
        <div className="flex justify-center my-5">
          <span className="text-4xl">Available Rooms</span>
          <div>{/* <Carosuel /> */}</div>
        </div>
      </MaxWidthWrapper>
    </div>
